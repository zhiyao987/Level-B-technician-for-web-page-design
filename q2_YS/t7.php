<fieldset>
	<legend>目前位置：首頁＞分類網誌＞<span id="tt"></span></legend>
<table width="90%" align="center">
	<tr>
		<td width="30%" valign="top">
<fieldset>
	<legend>分類網誌</legend>
	<div id="c11" onclick="op_t7('c1')">健康新知</div>
	<div id="c21" onclick="op_t7('c2')">菸害防治</div>
	<div id="c31" onclick="op_t7('c3')">癌症防治</div>
	<div id="c41" onclick="op_t7('c4')">慢性病防治</div>
</fieldset>
		</td>
		<td valign="top">
	<div id="c1"  >
...
function op_t7(x){
	...
	document.getElementById("tt").innerHTML=document.getElementById(x+"1").innerHTML;
}
op_t7("c1");
</script>